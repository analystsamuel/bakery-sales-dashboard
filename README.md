...
This ia an end-to-end data analytics project transforming raw retail transactional logs into an interactive 3-page business intelligence dashboard using SQL and Power BI.

## Project Files
* **bakery queries.sql** – Database creation, bulk ingestion, and data cleaning scripts.
* **Bakery Sales Dashboard.pbix** – Compiled Power BI dashboard with data model and DAX measures.
* **Bakery Sales.csv / Bakery price.csv** – Raw transactional data used for processing.
...
* **De-duplication:** Identified and purged duplicate transaction IDs to protect analytical accuracy.
